...
def visualize_attributions(attributions, title, save_path=None, show_plot=False):
    """
    ...
    # Helper function to safely convert tensor/array to numpy, keeping scalars as scalars
    def to_scalar_or_numpy(x):
